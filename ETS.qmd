...
The plot show the fit of the models with the blue line representing the LS model and the red line the DAMPEDS model.
```{r, warning=FALSE, message=FALSE}
tesla %>% autoplot(deliveries) + theme_classic() + 
...
fit %>%
  ...
  gt() %>%
  cols_align("center") %>% 
  tab_header(title = md("**ETS Forecast**")) %>%
  tab_style(
