...
4. João “Golden Toes” Silva is the next Brazilian league wonder kid, and Arsenal's scouts are buzzing with excitement. The club’s analysts estimate that João has a 70% chance of being a success at Arsenal, performing at a top level and helping the club win titles.
    ...
    Given the risk of signing the player, the club can conduct a thorough physical exam on João to ensure he’s healthy and injury-free. The cost of this physical test is £3 million.
    ...
    Should Arsenal conduct the physical test and then decide whether to sign João “Golden Toes” Silva, or should they take a chance and sign him without the test? Should they try to find ways to lower the price of the test?
    
<details>
  <summary>Suggested Answer</summary>
*Without the test, the expected value is 10,200,000. With the test the expected value is 9,350,000. We would **recommend Arsenal to go without the test and sign the player**. If the club can decrease the value of the test, then it should*
</details>