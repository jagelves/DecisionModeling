...
which is higher than the EMV of making the decision without the consultants (1.8 million). In fact, the CEO would be willing to pay up to \$1,000,000 for the consulting service.

## Readings

Readings for this chapter are mainly from @PMS. Chapter 9 provides a good introduction to decision models with a couple of solved problems included using excel. I would recommend using R to make calculations instead. To construct decision trees you can use *mermaid*.\
