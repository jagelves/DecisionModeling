...
Readings for this chapter are mainly from @PMS. Chapter 9 provides a good introduction to decision models with a couple of solved problems using excel. I would recommend using R to make calculations since we will be mainly using R. To construct decision trees in R you can use [mermaid](https://www.rdocumentation.org/packages/DiagrammeR/versions/1.0.10/topics/mermaid).\
