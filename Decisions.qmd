...
<details>
  <summary>Suggested Answer</summary>
*Without the test, the expected value is 10,200,000. With the test the expected value is 9,354,000. We would **recommend Arsenal to go without the test and sign the player**. If the club can decrease the price of the test to at most 2,154,000*
</details>