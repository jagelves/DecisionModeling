...
These reading will help you review the concepts and theory necessary for completing this module. @HOP reviews the R basics needed to perform computer simulation, @JK introduces probability distributions, @GelvesBS has several applied problems (with solutions) in R to review the probability distributions, while @PMS provides an application of the distributions to business simulation.
