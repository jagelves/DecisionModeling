...
As you can see, the `rbinom()` function has yielded $5$ simulated outcomes from the binomial experiment with a probability of $0.7$. With these demands the bookstore can prepare for different demand scenarios as well as assessing the profitability of the Monster Series.
...
@PMS Chapter 10.1 and 10.2. Pay special attention to the probability distributions and try to replicate the examples in R.
