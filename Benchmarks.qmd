...
We'll create a time variable so that we can run the Least Squares method. An object with the fit of every method discussed above is then created with the model function.
