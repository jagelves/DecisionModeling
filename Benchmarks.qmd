...
You will notice that the *fit* object is a mable (model table). To explore the coefficients of the models estimated, we use the `coef()` function. The output table has been enhanced visually by using the [`gt`](https://gt.rstudio.com) package.
